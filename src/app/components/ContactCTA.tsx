...
<Link href="/contact" className="mt-6 inline-block px-8 py-4 rounded-full bg-[#fbbf24] text-[#211e59] font-semibold shadow hover:bg-yellow-500 transition">Get a Free Consultation</Link>
</div>
</section>
);
}