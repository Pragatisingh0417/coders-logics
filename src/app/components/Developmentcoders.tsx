...
export function DevelopmentCoders() {
  const steps = [
    { step: "01", title: "Planning", desc: "Understanding goals & requirements." },
    { step: "02", title: "Design", desc: "UI/UX tailored for users." },
    { step: "03", title: "Development", desc: "Clean, scalable implementation." },
    { step: "04", title: "Launch", desc: "Testing, deployment & support." },
  ];
